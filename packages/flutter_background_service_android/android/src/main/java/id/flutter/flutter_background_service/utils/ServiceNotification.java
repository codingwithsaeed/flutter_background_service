...
public class ServiceNotification {
    ...
    protected static final HashMap<String, Integer> MONTH_DAY_ICONS = new HashMap<String, Integer>() {
        {
    ...
    protected static int getIcon(String day) {
        Integer icon = MONTH_DAY_ICONS.get(day);
        return icon == null ? R.drawable.ic_bg_service_small : icon;
    }
    ...
    protected static RemoteViews bigContentView(Context context, NotificationData notificationData) {
        ...
        Bitmap dayWrapperBitmap = BitmapUtils.colorFilterOf(context, R.drawable.soha_widget, adaptiveColor);
    ...
    public static NotificationCompat.Builder builder(
        ...
        return new NotificationCompat.Builder(context, channelId)
                .setSmallIcon(getIcon(notificationData.getDay()))
